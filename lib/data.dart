  ...
  List<Game> games2 = [
    ...
    Game(
      ...
      GameImage("https://assets1.ignimgs.com/2018/12/14/metro-exodus---button-1544750418985.jpg", ""),
      "",
      "Naughty Dog",
    ),
    Game(
      ...
      GameImage(
          "https://th.bing.com/th/id/OIP.7OqWeOd0Oty5TM94ixRf6AHaEK?rs=1&pid=ImgDetMain",
          ""),
      "",
      "From Software",
    ),
  ...
  List<Game> featuredGames = [
    ...
    Game(
      ...
      GameImage(
          "http://cdn.division.zone/uploads/2019/03/tc-the-division-2-preload-start-times-sizes-header.jpg",
          ""),
      "",
      "CyberConnect2",
    ),
